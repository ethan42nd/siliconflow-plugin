                ...
                "list": [
                    {
                        "icon": 64,
                        "title": "#sf登录",
                        "desc": "获取 WebUI 一次性登录验证码（5分钟有效）"
                    },
                    {
                        "icon": 65,
                        "title": "#sf申请webui",
                        "desc": "在审批模式下申请 WebUI 使用权限"
                    },
                    {
                        "icon": 66,
                        "title": "#sf我的webui状态",
                        "desc": "查看自己的 WebUI 权限状态"
                    },
                    {
                        "icon": 79,
                        "title": "#sf登录历史",
            ...
            },
            {
                ...
                "list": [
                    ...
                    },
                    {
                        "icon": 77,
                        "title": "#sf强制下线 QQ号",
                        "desc": "踢出指定用户，使其 Token 立即失效"
                    },
                    {
                        "icon": 75,
                        "title": "#sf轮换webui密钥",
                        "desc": "强制刷新 JWT Secret，所有用户需重新登录"
                    },
                ]
            }
        ]
